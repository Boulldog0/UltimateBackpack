...
public class BackpackItemAddEvent extends Event {
	...
	public BackpackItemAddEvent(Player player, int slot, ItemStack item, String ownerName, boolean playerEditInAdmin) {
		this.player = player;
		this.slot = slot;
		this.stack = item;
